...
| **Intent (намерение)** | Классифицированное намерение пользователя. Бот определяет intent на каждом ходе (233 интента в 34 категориях). Примеры: `greeting`, `price_question`, `demo_request`, `objection_price`. |
...
| 233 интента | Классификация намерений пользователя в 34 категориях |
...
233 интента, каждый с атрибутами:
