...
TEST_QUERIES = {
    ...
    "pricing_kit_pro_435": [
        "кассовый комплект pro wipon 360000",
        "комплект pro wipon 360000 тенге",
        "360000 комплект pro wipon цена",
    ],
    ...
    "pricing_scales_rongta_438": [
        "весы rongta wipon цена 200000",
        "rongta весы wipon 200000 тенге",
        "200000 весы rongta wipon цена",
    ],
    "pricing_stand_zebra_439": [
        "подставка zebra wipon 10000 тенге",
        "zebra подставка цена 10000",
        "10000 подставка zebra wipon цена",
    ],
    "pricing_stand_simple_440": [
        "простая подставка wipon 3000 тенге",
        "подставка 3000 простая wipon",
        "3000 простая подставка wipon цена",
    ],
    "pricing_scanner_wp7600l_441": [
        "сканер wp7600l wipon цена 30000",
        "wp7600l сканер wipon 30000 тенге",
        "wp7600l 30000 тенге wipon",
    ],
