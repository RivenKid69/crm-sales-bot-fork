...
TEST_QUERIES = {
    ...
    "support_setup_401": [
        ...
        "кто настроит кассу?",
        "кто поможет настроить программу?",
    ],
    ...
    "support_refund_request_406": [
        ...
        "верните мне деньги обратно пожалуйста",
    ],
    ...
    "support_equipment_return_409": [
        ...
        "техника wipon не подошла хочу вернуть",
        "купил технику хочу вернуть",
    ],
    ...
    "support_payment_check_415": [
        "перевёл оплату проверьте пожалуйста",
        "посмотрите мою оплату",
    ...
    "products_theft_protection_kz_423": [
        "ұрлықтан қорғау wipon арқылы",
        "кассир әрекеттерін бақылау",
    ...
    "pricing_triple_434": [
        "wipon triple цена",
        "triple стоимость сколько?",
        "triple за сколько купить?",
    ],
    "pricing_kit_pro_435": [
        "комплект pro цена",
    ...
    "pricing_smart_scales_436": [
        ...
        "умные весы стоимость",
        "сколько стоят умные весы wipon?",
    ],
