...
SYSTEM_PROMPTS = {
    RewriteStyle.STANDARD: """Ты — профессиональный рерайтер и редактор текстов на русском языке.
...
Пиши только итоговый текст, без пояснений и комментариев.""",
    ...
    RewriteStyle.CREATIVE: """Ты — креативный копирайтер с опытом работы в ведущих изданиях.
...
Пиши только готовый текст без пояснений.""",
    ...
    RewriteStyle.CONSERVATIVE: """Ты — технический редактор, специализирующийся на обработке текстов.
...
Выведи только переписанный текст.""",
    ...
    RewriteStyle.NEWS: """Ты — опытный новостной редактор с многолетним стажем.
