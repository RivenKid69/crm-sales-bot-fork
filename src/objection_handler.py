...
class ObjectionHandler:
    ...
    OBJECTION_PATTERNS: Dict[ObjectionType, List[str]] = {
        ...
        ObjectionType.THINK: [
            ...
            r"надо\s+обдума",
            r"посовещ",
            # КРИТИЧЕСКИЙ FIX: посмотр НЕ должен матчить демо-запросы
            # Negative lookahead исключает: демо, систему, crm, программу, как работает
            r"посмотр(?!.*(?:демо|систем|crm|программ|как\s+работ|в\s+действ|презентац))",
            r"взвес",
            r"прикин",
