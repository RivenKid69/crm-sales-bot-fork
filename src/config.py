...
products (115 секций) — ПРОДУКТЫ И ВЫБОР РЕШЕНИЯ:
...
equipment (184 секции) — оборудование и периферия:
...
pricing (104 секции) — цены и тарифы:
...
inventory (98 секций) — товары и склад:
...
integrations (71 секция) — интеграции с внешними сервисами:
  Kaspi.kz, Halyk Market, банки, эквайринг, POS-терминалы,
  маркировка товаров, 1С, ОФД, синхронизация заказов, API

regions (61 секция) — регионы и доставка оборудования:
...
features (59 секций) — ФУНКЦИИ ВНУТРИ ПРОГРАММЫ:
