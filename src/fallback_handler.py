...
class FallbackHandler:
    ...
    EXIT_TEMPLATES: List[str] = [
        "Похоже, сейчас не лучшее время для подробного разговора. Если будет актуально, оставьте номер телефона — коллега позвонит.",
        "Давайте так: когда будет удобно, оставьте номер телефона, и мы свяжемся с вами. Хорошо?",
        "Понимаю, что времени мало. Могу просто прислать краткую информацию — посмотрите когда будет время.",
        "Не буду отнимать время. Оставьте номер телефона — коллега позвонит, а вы спокойно решите.",
    ]
