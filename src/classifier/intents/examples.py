...
INTENT_EXAMPLES: Dict[str, List[str]] = {
    ...
    "objection_no_need": [
        ...
        "нам не требуется автоматизация",
        "мы маленькие, нам не надо",
        "обходимся без этого",
        "хватает текущих инструментов",
        "excel нас устраивает",
        "ведём всё в блокноте",
        "зачем нам это нужно",
    ...
    "objection_trust": [
        ...
        "а есть гарантии",
        "кто ещё пользуется вашей системой",
        "покажите отзывы клиентов",
        "откуда мне знать что не обманете",
        "звучит слишком хорошо",
        "не верю в такие обещания",
        "какие есть доказательства",
        "а что если не поможет",
        "можете подтвердить результаты",
        "хочу увидеть референсы",
        "кейсы из нашей отрасли есть",
        "почему должен вам доверять",
    ],
    ...
    "objection_timing": [
        ...
        "перезвоните через месяц",
        "в следующем квартале обсудим",
        "после праздников вернёмся",
        "сейчас не лучшее время",
        "подождите до весны",
        "может быть в следующем году",
        "пока рано об этом говорить",
        "через полгода напомните",
        "после отпуска созвонимся",
        "ближе к концу года",
        "когда бюджет сформируем",
        "после закрытия проекта",
    ],

    "objection_complexity": [
        "слишком сложно внедрять",
        "долго настраивать систему",
        "много работы с переходом",
        "придётся переучивать команду",
        "интеграция займёт месяцы",
        "у нас нет ресурсов на внедрение",
        "это потребует много сил",
        "процесс миграции пугает",
        "боюсь что всё сломается",
        "переход будет болезненным",
        "надо переносить данные",
    ...
    "problem_sync": [
        ...
        "касса не обновляет остатки",
        "синхронизация зависла между терминалами",
        "на одном устройстве одно а на другом другое",
        "база не обновляется на кассах",
        "не могу синхронизировать каталог товаров",
        "расхождение данных между точками продаж",
    ],

    "problem_connection": [
        "касса не подключается к интернету",
        "нет связи с сервером",
        "пропало соединение с облаком",
        "терминал не видит сеть",
        "постоянно отваливается подключение",
        "ошибка соединения с базой данных",
        "не могу подключиться к личному кабинету",
    ],

    "problem_technical": [
        "программа вылетает с ошибкой",
        "экран не реагирует на нажатия",
        "система зависает при оплате",
        "приложение крашится при открытии",
        "выдаёт ошибку при загрузке",
        "техническая проблема с терминалом",
        "софт не запускается после обновления",
    ],

    "problem_fiscal": [
        "чек не пробивается",
        "фискальный модуль не работает",
        "ошибка при печати чека",
        "кассовый аппарат не фискализируется",
        "Z-отчёт не закрывается",
    ...
    "request_technical_support": [
        ...
        "позовите техподдержку",
        "нужен технический специалист",
        "у меня технический вопрос к инженеру",
        "хочу обратиться в саппорт",
        "можете подключить техника",
        "нужна помощь с настройкой оборудования",
    ],

    "request_configuration": [
        "помогите настроить систему",
        "нужна помощь с конфигурацией",
        "как настроить кассу",
        "не могу настроить интеграцию",
        "помогите сконфигурировать оборудование",
        "нужно настроить программу под наш бизнес",
        "требуется настройка рабочего места",
    ],

    "request_references": [
        "покажите список ваших клиентов",
        "кто из ресторанов вас использует",
        "есть отзывы от реальных клиентов",
        "какие компании уже работают с вами",
        "можете дать контакты ваших клиентов",
        "есть кейсы внедрения",
