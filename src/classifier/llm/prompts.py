...
6. **contact_info** (str): ТОЛЬКО телефон (+7... или 8...) или email (xxx@xxx.xx)
   - ✅ "+7 999 123-45-67", "87751234567", "user@example.com"
   - ✅ KZ формат: 87xxx, +77xxx (например, 87012345678, +77751234567)
   - ❌ "теряем клиентов" — ЭТО БОЛЬ! → pain_point
...
7. **kaspi_phone** (str): Казахстанский номер телефона Kaspi (для оплаты)
   - ✅ "87012345678", "+77751234567", "Kaspi 87751234567"
...
8. **iin** (str): ИИН клиента — ровно 12 цифр
   - ✅ "123456789012", "900612345678"
   - ✅ Если клиент пишет "ИИН 123456789012" или просто 12 цифр после слова ИИН
