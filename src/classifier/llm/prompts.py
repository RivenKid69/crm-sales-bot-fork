...
2. **current_tools** (str): ТОЛЬКО CRM/инструменты учёта клиентов
...
3. **contact_info** (str): ТОЛЬКО телефон (+7...) или email (xxx@xxx.xx)
